...
**Агент раскрывается на весь экран** иконкой в правом верхнем углу своей шапки — и на телефоне, и
на большом экране: чат здесь основной инструмент правок, и иногда нужен целиком, а не полосой
сбоку. Содержимое при этом ограничено по ширине, чтобы строки не растягивались на весь монитор.
...
подписи кнопок сворачиваются в иконки, у спайна прячется легенда, а чат свёрнут в одну строку —
разворачивается нажатием и сам открывается, когда отправляешь сообщение.
