...
Жесты: сдвиг в сторону — по полю таймлайна или по списку задач — прокручивает диаграмму по
времени; сдвиг вверх-вниз прокручивает список (ось определяется по первым шести пикселям
движения); нажатие с удержанием на строке поднимает задачу для переноса — на телефоне это
единственный способ, потому что свайп занят прокруткой. Обработчики жестов навешиваются один раз,
а свежие колбэки читаются через ref: пока они висели в эффекте с зависимостями, любая перерисовка
снимала слушатели вместе с таймером удержания, и жест не срабатывал.
