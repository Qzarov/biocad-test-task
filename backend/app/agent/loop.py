...
- Номер — это позиция в списке, она меняется при переупорядочивании. Если номер и название в одной ссылке противоречат друг другу, работай по названию и скажи об этом одной фразой, а не переспрашивай.
